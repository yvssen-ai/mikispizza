...
import heroImage from '../assets/images/miki-pepperoni.jpg'
...
export function Hero() {
  return (
    ...
    >
      <img
        src={heroImage}
        alt="Fresh pepperoni pizza with a cheese pull, Miki's Pizza"
      ...
      >
        <motion.div
          ...
          className="flex h-9 w-6 items-start justify-center rounded-full border-2 border-miki-cream/40 p-1"
        >
          <span className="h-1.5 w-1.5 rounded-full bg-miki-cream/70" />
        </motion.div>
      </motion.div>
    </section>
  )
